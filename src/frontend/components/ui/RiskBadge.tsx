...
import { SeverityLevel, NotificationSeverity } from '../../types';

interface RiskBadgeProps {
  severity: SeverityLevel | NotificationSeverity | string;
  score?: number;
  size?: 'sm' | 'md';
}
...
export const RiskBadge: React.FC<RiskBadgeProps> = ({ severity, score, size = 'sm' }) => {
  ...
  if (s === 'healthy') {
    ...
    badgeClasses =
      'bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-400 border-rose-200 dark:border-rose-800/50 font-bold shadow-2xs';
  }
